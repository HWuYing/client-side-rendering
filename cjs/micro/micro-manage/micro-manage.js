...
let MicroManage = class MicroManage {
    ...
    bootstrapMicro(microName) {
        ...
        if (!storeSubject) {
            storeSubject = this.la.readMicroStatic(microName).pipe((0, import_rxjs_1.tap)(({ links }) => Object.assign(this.chunkMap, { [microName]: links })), (0, import_rxjs_1.map)((result) => new micro_store_1.MicroStore(microName, result, this)), (0, import_rxjs_1.shareReplay)(1));
